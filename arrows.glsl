...
/* ---------------------------------------------------------
  Computes the signed distance from a line segment (p1,p2)
  --------------------------------------------------------- */
...
/*
   ...
   Parameters:
   -----------
   texcoord:  Point coordinates (in pixels)
   body:      Total length of arrow body (pixels)
   head:      Length of head (pixels)
   linewidth: Line width (in pixels)
   antialias: Atialiased area (in pixels)
